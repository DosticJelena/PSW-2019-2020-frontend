...
class MedicalCard extends React.Component {
    ...
    handleCancelClick = () => {
        ...
        axios.get('https://deployment-isa.herokuapp.com/api/medicalRecords/get/' + patientId, {
          responseType: 'json'
        })
              .then(response => {
    ...
    checkVersionChanged() {
        axios.get("https://deployment-isa.herokuapp.com/api/medicalRecords/check-version", {
    ...
    handleSaveClick = () => {
        ...
        axios.get("https://deployment-isa.herokuapp.com/api/medicalRecords/check-version", {
            ...
            axios.put("https://deployment-isa.herokuapp.com/api/medicalRecords/edit", {
