...
class EditExaminationReport extends React.Component {
  ...
  constructor(props){
   ...
   componentDidMount () {
    ...
    axios.get('https://deployment-isa.herokuapp.com/api/examination-report/get-examination-report/' + examinationReportId, { 
      responseType: 'json'
    })
          .then(response => {
  ...
  publishExaminationReport = event => {
      ...
      if (formValid(this.state)) {
          axios.put("https://deployment-isa.herokuapp.com/api/examination-report/edit/" + examinationReportId, {
