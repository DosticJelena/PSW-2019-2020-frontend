...
class MedicalRecord extends React.Component{
    ...
    componentDidMount(){
      ...
      axios.get("https://deployment-isa.herokuapp.com/auth/getMyUser")  
        .then(response => {
            ...
            var token = localStorage.getItem('token');
            axios.defaults.headers.common['Authorization'] = `Bearer ${token}`;
            axios.get("https://deployment-isa.herokuapp.com/api/medicalRecords/"+response.data.id)  
              .then(response => {
              ...
              var token = localStorage.getItem('token');
              axios.defaults.headers.common['Authorization'] = `Bearer ${token}`;
              axios.get('https://deployment-isa.herokuapp.com/api/appointment/future-cancel-appointments/' +response.data.id).then(response => {
              ...
              var token = localStorage.getItem('token');
              axios.defaults.headers.common['Authorization'] = `Bearer ${token}`;
              axios.get('https://deployment-isa.herokuapp.com/api/appointment/future-fix-appointments/' +response.data.id).then(response => {
   ...
   cancelApp = (id) =>{
    console.log(id);
    axios.put("https://deployment-isa.herokuapp.com/api/appointment/cancel-Patient/" + id).then(response => {
