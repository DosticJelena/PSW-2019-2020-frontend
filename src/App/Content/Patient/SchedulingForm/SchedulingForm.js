...
class SchedulingForm extends React.Component {
        ...
        sendRequest = ()=>{
          ...
          axios.post("https://deployment-isa.herokuapp.com/api/appointment-request", {
        ...
        componentDidMount(){
          ...
          axios.get("https://deployment-isa.herokuapp.com/api/doctors/" + doctorsId)
          .then(response => {
              console.log(response.data);
              this.setState({
        ...
        axios.defaults.headers.common['Authorization'] = `Bearer ${token}`;
        axios.get("https://deployment-isa.herokuapp.com/api/get-appointment-details/"+specializationId)
          .then(response => {
            console.log(response.data);
            this.setState({
