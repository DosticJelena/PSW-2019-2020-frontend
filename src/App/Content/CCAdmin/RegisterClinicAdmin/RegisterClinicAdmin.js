...
class RegisterClinicAdmin extends React.Component {
  ...
  constructor(props){
   ...
   componentDidMount() {
    axios.get("https://deployment-isa.herokuapp.com/api/cc-admin/get-all-clinics")
            .then((resp) => {
                this.setState({
                    clinics: resp.data
                })
  ...
  SendRegisterRequest = event => {
      ...
      if (formValid(this.state)) {
          axios.post("https://deployment-isa.herokuapp.com/api/cc-admin/register-clinic-admin", {
