...
class CCAdminRegistrationRequests extends React.Component{
      ...
      fetchData(state, instance) {
        ...
        axios.get('https://deployment-isa.herokuapp.com/api/cc-admin/all-registration-requests', {
              responseType: 'json'
          }).then(response => {
      ...
      accept = (id) =>{
        axios.put("https://deployment-isa.herokuapp.com/api/cc-admin/send-verification-email/" + id).then(response => {
      ...
      reject = () =>{
        if (this.state.message != ""){
          axios.put("https://deployment-isa.herokuapp.com/api/cc-admin/reject-registration-request/" + this.state.id, this.state.message).then(response => {
