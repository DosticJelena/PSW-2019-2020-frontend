...
class Prescriptions extends React.Component{
    ...
    fetchData(state, instance) {
      this.setState({ loading: true });
        axios.get('https://deployment-isa.herokuapp.com/api/nurse/get-awaiting-prescriptions', {
            responseType: 'json'
        }).then(response => {
            this.setState({ 
    ...
    authenticate = (id) =>{
      axios.post("https://deployment-isa.herokuapp.com/api/nurse/authenticate/" + id).then(response => {
